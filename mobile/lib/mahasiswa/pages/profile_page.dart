                    ...
                    GlassCard(
                      child: Column(
                        children: [
                          ...
                          _divider(),
                          _buildItem(Icons.badge_rounded, "NIM", user?.identifier ?? "-", Colors.purple),
                          _divider(),
                          _buildItem(Icons.school_rounded, "Program Studi", user?.prodiName ?? "-", Colors.green),
                          _divider(),
                          _buildItem(Icons.stars_rounded, "Role", user?.role ?? "-", Colors.teal),
                        ],
                      ),
                    ),
